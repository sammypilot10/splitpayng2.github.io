...
import { AnimatedMarketplace } from '@/components/home/AnimatedMarketplace'
...
export default async function Home({ searchParams }: { searchParams: { category?: string } }) {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-fintech-slate overflow-x-hidden">
        ...
        <AnimatedHero>
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center w-full">
            ...
            <div className="flex flex-col items-center text-center lg:items-start lg:text-left z-10">
              <div className="hero-reveal inline-flex items-center gap-2 px-3 py-1 rounded-full bg-fintech-gold/10 text-fintech-gold font-medium text-sm mb-6 border border-fintech-gold/20">
                <ShieldCheck size={16} />
                <span>100% Escrow Protected</span>
              </div>

              <h1 className="hero-reveal text-5xl lg:text-6xl font-extrabold tracking-tight text-fintech-navy leading-[1.1] mb-6">
              ...
              <p className="hero-reveal text-lg lg:text-xl text-fintech-navy/70 max-w-xl mb-10 leading-relaxed">
              ...
              <div className="hero-reveal mt-8 flex items-center gap-4 text-sm font-medium text-fintech-navy/60">
            ...
            {/* Right Column - Mockup */}
            <div className="hero-mockup relative w-full max-w-lg mx-auto lg:max-w-none mt-10 lg:mt-0">
              <div className="hero-glow absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[120%] bg-gradient-to-tr from-fintech-gold/30 via-blue-400/20 to-fintech-navy/5 rounded-full blur-3xl -z-10" />
      ...
      <AnimatedStats>
        <div className="bg-white rounded-2xl shadow-xl p-8 grid grid-cols-2 md:grid-cols-4 gap-8 divide-x divide-gray-100">
          <div className="stat-item text-center">
            <p className="stat-number text-3xl font-bold text-fintech-navy">₦12M+</p>
            <p className="text-sm text-gray-500 font-medium">Saved by users</p>
          </div>
          <div className="stat-item text-center">
            <p className="stat-number text-3xl font-bold text-fintech-navy">4.9/5</p>
            <p className="text-sm text-gray-500 font-medium">Trust Score</p>
          </div>
          <div className="stat-item text-center">
            <p className="stat-number text-3xl font-bold text-fintech-navy">0</p>
            <p className="text-sm text-gray-500 font-medium">Scams via Escrow</p>
          </div>
          <div className="stat-item text-center">
            <p className="stat-number text-3xl font-bold text-fintech-gold">{pools?.length || 0}</p>
      ...
      {/* ── Marketplace ── */}
      <AnimatedMarketplace>
        <div className="marketplace-header flex flex-col md:flex-row justify-between items-center mb-8 gap-4">
      ...
      {/* ── Calculator Section ── */}
      <AnimatedSection
        className="bg-fintech-navy py-24 px-6 text-white overflow-hidden"
        direction="up"
      >
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          <div>
            <h2 className="section-reveal text-4xl font-bold mb-6">
              Stop paying full price for subscriptions you rarely use.
            </h2>
            <p className="section-reveal text-lg text-fintech-slate/60 mb-8 leading-relaxed">
            ...
            <ul className="space-y-4">
              <li className="section-reveal flex items-center gap-3"><ShieldCheck className="text-fintech-gold"/> 100% Escrow protected</li>
              <li className="section-reveal flex items-center gap-3"><Lock className="text-fintech-gold"/> End-to-end encrypted credentials</li>
              <li className="section-reveal flex items-center gap-3"><Zap className="text-fintech-gold"/> Automated Paystack billing</li>
            </ul>
          </div>
      ...
      >
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="section-reveal text-3xl font-bold text-fintech-navy mb-4">Frequently Asked Questions</h2>
            <p className="section-reveal text-gray-500">Everything you need to know about sharing securely on SplitPayNG.</p>
          </div>
          ...
          <div className="space-y-4">
            {faqs.map((faq, index) => (
              <details
                key={index}
                className="section-reveal group bg-gray-50 rounded-2xl border border-gray-100 [&_summary::-webkit-details-marker]:hidden"
              >
        ...
        <section className="bg-white py-24 px-6 text-center border-t border-gray-100">
          <div className="max-w-3xl mx-auto">
            ...
            <Link href="/auth">
              <Button
                variant="primary"
                className="cta-button text-xl px-10 py-6 rounded-full shadow-2xl shadow-fintech-navy/20 hover:-translate-y-1 transition-transform"
              >
                Create Free Account
              </Button>
            </Link>
